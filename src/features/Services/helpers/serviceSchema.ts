import { mustBeCharactersMessage } from "./../../../constants/schemaConstants";
import {
  taxFieldValidMessage,
  priceFieldRequiredMessage,
  pricePerUnitEnterMessage,
  pricePerHourEnterMessage,
  imageSupportedFormatMessage,
  fieldRequiredMessaage,
} from "@constants/schemaConstants";
import * as yup from "yup";
import { SUPPORTED_IMAGES_FORMAT } from "@constants/constants";
